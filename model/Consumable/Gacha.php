...
class Soccer_Service_Soccer_Module_User_Consumable_Gacha extends Soccer_Service_Soccer_Module_User_Consumable
{
    /**
     * Modules used
     *
    ...
    protected $_propertyName = 'points_gacha';
    protected $_propertyMaxAmountName = 'max_points_gacha';
