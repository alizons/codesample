 ...
 *
 */
class Soccer_Service_Soccer_Processor_User_Decreaseconsumable extends Soccer_Service_Soccer_Processor
{
    ...
    public function process()
    {
        ...
        $this->set('data', $consumableModule->decrease($userid, $value));
        return true;
    }
}
